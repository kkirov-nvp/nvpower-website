...
function buildSteps(locale: Locale): { steps: Step[]; strings: Record<string, string> } {
  if (locale === "bg") {
    return {
      strings: {
        ...
        successText: `Ще получиш потвърждение веднага и обаждане от консултант до 3 работни дни (в работно време). Междувременно можеш да разгледаш проектите ни.`,
  ...
  return {
    strings: {
      ...
      successText: `You'll get an instant confirmation and a call from a consultant within 3 business days (during business hours). Meanwhile, have a look at our projects.`,
